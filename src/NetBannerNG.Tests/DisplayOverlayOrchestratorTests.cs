...
{
    [TestClass]
    public class DisplayOverlayOrchestratorTests
    {
        [TestMethod]
        public void BuildGroupId_UsesMonitorName_WhenPresent()
        {
            var id = DisplayOverlayOrchestrator.BuildGroupId("\\.\\DISPLAY1", new Rect(0, 0, 1920, 1080));
        ...
        {
            var id = DisplayOverlayOrchestrator.BuildGroupId("", new Rect(10, 20, 1280, 720));
        ...
        {
            var changed = DisplayOverlayOrchestrator.HasMonitorLayoutChanged(
